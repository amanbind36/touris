    ...
    <div className={Styles.main}>
      ...
      <br/>
         ...
         <div className={Styles.destination}>
          ...
          <div>
          <Link className={Styles.ink} to="/uttar">
          <div className={Styles.upper}>
            <img width="100%" height="100%" src={taj2}/>
          </div>
            <div className={Styles.downer}>
            <h3>Uttar Pradesh:Trip</h3>
                <p>From 9,983 per adult</p>
            </div>
            </Link>
          </div>
          ...
          <div>
          <Link className={Styles.ink} to="/jammu">
          <div className={Styles.upper}>
            <img width="100%" height="100%" src={k}/>
          </div>
            <div className={Styles.downer}>
            <h3>Jammu & Kasmir:Trip</h3>
                <p>From 9,983 per adult</p>
            </div>
            </Link>
          </div>
          ...
          <div>
          <Link className={Styles.ink} to="/tamilNadu">
          <div className={Styles.upper}>
            <img width="100%" height="100%" src={t}/>
          </div>
            <div className={Styles.downer}>
            <h3>Tamil Nadu :Trip</h3>
                <p>From 9,983 per adult</p>
            </div>
            </Link>
          </div>
          ...
          <div>
          <Link className={Styles.ink} to="/sikkim">
          <div className={Styles.upper}>
            <img width="100%" height="100%" src={s1}/>
          </div>
            <div className={Styles.downer}>
            <h3> Sikkim:Trip</h3>
                <p>From 9,983 per adult</p>
